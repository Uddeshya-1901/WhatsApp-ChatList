...
const chat_names = ["Pravin Devghare", "Jayesh", "Tejal", "Chinmay", "Saloni", "Prasad", "Sachin"];
...
class ChatHandler{
    ...
    createNode(id){
        ...
        console.log("avatar" + eval(1+(id%chat_img_length)) + ".png");
        chat_item.querySelector('#Image').src = "avatar" + eval(1+(id%chat_img_length)) + ".png";
